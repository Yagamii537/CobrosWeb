        ...
        <div class="container-fluid">
            <form class="d-flex">
                <form action="" method="GET">
                    <input class="form-control me-2" type="date" placeholder="Buscar por fecha" name="busqueda"> <br>
                    <button class="btn btn-outline-info" type="submit" name="enviar"> <b>Buscar </b> </button>
                    <input type="hidden" name="redir" value="regis">
                </form>
        </div>
        <?php
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="efectivo"><?php echo $fila['efectivo']; ?></td>
                                <td class="transferencia"><?php echo $fila['transferencia']; ?></td>
                                ...
                                <td>
                                    ...
                                    <!-- <input type="hidden" value="<?php echo $fila['idRecibo']; ?>" id="id" name="id">
